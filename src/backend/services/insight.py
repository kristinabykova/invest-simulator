...
def test():
    return {"explanation": "Цена акции SBER незначительно снизилась в течение периода, двигаясь в узком диапазоне между максимумом и минимумом. Такая динамика типична для бокового тренда, когда спрос и предложение на акцию примерно равны.", "tip": "Обращай внимание на волатильность и ширину торгового диапазона, чтобы оценивать активность рынка.","terms": [{"term": "Боковой тренд","definition": "Ситуация на рынке, когда цена актива колеблется в горизонтальном диапазоне без явного роста или падения."},{"term": "Волатильность","definition": "Статистический показатель, который характеризует степень изменчивости цены актива за определенный период."}],"tone": "нейтрально-обучающий"}
